...
export const ProductAddToCard = styled(Button)(({show, theme})=> ({
    width: '120px',
    fontSize: '12px',
    [theme.breakpoints.up('md')]: {
        position: 'absolute',
...
export const ProductMetarWrapper = styled(Box)(({ theme }) => ({
    padding: 4,
    display: "flex",
    flexDirection: "column",
    alignItems: "center",                                         
...
export const ProductActionsWrapper = styled(Box)(({ show, theme }) => ({
    [theme.breakpoints.up("md")]: {
        ...
        right: 0,
        top: "20%",
        animation: show && `${slideInRight} 0.5s cubit- bezier(0.250, 0.460, 0.450, 0.940) both`,
    }
}));